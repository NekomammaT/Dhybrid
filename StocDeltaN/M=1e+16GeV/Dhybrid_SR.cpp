...
const string MODEL("Dhybrid_SR"); // model name

// ---------- for PDE ----------------------
const int MAXSTEP = 100000; // max recursion
const double TOL = 1e-10; // tolerance
// -----------------------------------------

// ---------- potential parameter ----------
const double AS = 2.1e-9;
const double MPL = 2.435e+18;
const double MM = 1e+16 / MPL;
const double PHIC = sqrt(2) * MM;
const double MU2 = 10; //10.7
// -----------------------------------------

// ---------- box size & step h ------------
const double PSIMIN = -MM*(1e-4); //-1e-3;
const double PSIMAX = -PSIMIN;
const double HPSIOPSI = 1e-2; // hpsi/|psi|

const double PHIMIN = 0.999995*PHIC;
// -----------------------------------------

// ---------- for SDE ----------------------
const int RECURSION = 100000; // recursion for power spectrum
const double TIMESTEP = 1e-3; // time step : delta N
// -----------------------------------------

// ---------- for power spectrum -----------
const double DELTAN = 0.5; // 0.1 // calc. PS every DELTAN e-folds
// -----------------------------------------
...
int main(int argc, char** argv)
{
  ...
  double phimin = PHIMIN; //0.1409; //0.141; // - 1./mu1/10;
